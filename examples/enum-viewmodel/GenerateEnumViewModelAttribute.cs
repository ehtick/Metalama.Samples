...
// [<endsnippet MultiInstance>]

        {
            ...
            var isFlags =
                enumType.Attributes.Any( a => a.Type.IsConvertibleTo( typeof(FlagsAttribute) ) );
    ...
    [Template]
    public void ConstructorTemplate<[CompileTime] T>( T value ) => meta.This._value = value!;
